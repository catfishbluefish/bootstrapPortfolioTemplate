...
var bio = {
	name : "cat fistori",
	role : "front-end web developer, designer, and photographer",
	contacts : {
		linkedin : {
			name: "catfistori",
	...
	skills : ["HTML", "CSS", "Javascript","jQuery", "Bootstrap", "Wordpress", "Squarespace", "Photoshop", "Lightroom", "Illustrator", "InDesign", "Shopify", "Order Desk", "Endicia", "Wordpress", "Gulp", "Jekyll", "Search Console", "Analytics", "Adwords", "Tag Manager"]
};//end of bio data
...
var projects = {
	...
	},
	{
		...
		dates :"Summer 2014",
		description : "Several month contract to transform and develop a chocolate product for sale in SF Bay stores. Position also evolved to include promotional photography of finished products.",
